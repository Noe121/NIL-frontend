...
const AgencyUserPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        // Fetch analytics
        const analyticsData = await apiService.getAgencyAnalytics(user.id);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome to Your Agency Dashboard</h1>
        <p className="text-lg text-gray-600">
          Manage your athletes and influencers portfolio
        </p>
      </div>
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-600">Create deals for your athletes using predefined templates</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-600">Create deals for your influencers using predefined templates</p>
            </div>
          </div>
      ...
      <div className="mb-8">
        ...
        <SearchComponent
          placeholder="Search for athletes to represent..."
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          <h2 className="text-2xl font-bold mb-4">Active Representations</h2>
          <div className="bg-white rounded-lg shadow divide-y">
            {activeSponshorships.length === 0 ? (
              <div className="p-4 text-center text-gray-500">
                No active representations
              </div>
            ) : (
      ...
      <div>
        ...
        <SponsorshipTasks userRole="agency" userAddress={user.wallet_address} />
      </div>
    </div>
  );
};

export default AgencyUserPage;